...
# from database.initialize_engine import Base
...
cable_line_metadata = CableLine.metadata
department_metadata = Department.metadata
employee_metadata = Employee.metadata
server_room_metadata = ServerRoom.metadata
workstation_metadata = Workstation.metadata
